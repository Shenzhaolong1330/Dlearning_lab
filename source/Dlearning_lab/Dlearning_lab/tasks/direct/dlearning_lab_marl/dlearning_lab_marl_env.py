...
from .dlearning_lab_marl_env_cfg import DlearningLabMarlEnvCfg


class DlearningLabMarlEnv(DirectMARLEnv):
    cfg: DlearningLabMarlEnvCfg

    def __init__(self, cfg: DlearningLabMarlEnvCfg, render_mode: str | None = None, **kwargs):
